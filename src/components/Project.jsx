...
import EnhanceImg from "/src/assets/ProjImg/Enhance.png";
  ...
  return (
    <div className="bg-white h-[calc(100vh-56px)]">
      ...
      <div className="flex justify-center flex-col items-center">
        ...
        <p className="text-lg font-semibold text-gray-800 mt-2 tracking-[0.1rem]">
      ...
      <div className="flex flex-wrap justify-center gap-8 mt-20">
        ...
        <ProjectCard
          ...
          techStack={["ReactJs", "TailwindCSS", "Framer motion", "Javascript"]}
          liveLink="#"
